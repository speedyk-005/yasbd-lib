...
class ElRules(Rules):
    ...
    COMMON_SENT_STARTERS = {
        ...
        "Εγώ", "Εδώ", "Εκεί", "Εκείνα", "Εκείνες", "Εκείνη",
        "Εκείνο", "Εκείνοι", "Εκείνος", "Εμείς", "Εσείς", "Εσύ",

        # Question words
        "Γιατί", "Ποια", "Ποιαν", "Ποιανής", "Ποιανού", "Ποιες",
        "Ποιο", "Ποιοι", "Ποιον", "Ποιος", "Πού", "Πότε", "Πώς",
        "Τι",

        # Adverbs
        "Έπειτα", "Αργότερα", "Αρχικά", "Δεύτερον",
        "Διαφορετικά", "Εντούτοις", "Εντωμεταξύ", "Εξάλλου",
        "Επί του παρόντος", "Επίσης", "Επιπλέον", "Επομένως",
        "Μετά", "Προηγουμένως", "Πρώτα", "Στη συνέχεια",
        "Συνεπώς", "Τέλος", "Τελευταία", "Τελικά", "Τρίτον",
        "Τότε", "Ωστόσο",
