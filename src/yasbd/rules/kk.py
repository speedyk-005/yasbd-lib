...
class KkRules(Rules):
    ...
    TITLE_ABBRVS = Rules.TITLE_ABBRVS | {
        ...
        "акад", "проф", "доц", "асс", "д-р", "канд", "дир", "орынб", "басқ", "мүше-корр",
        "м.а", "к.м.с", "д.м.с", "к.т.н", "д.т.н",

        # Kazakh Academic Degrees (Highly critical dotted abbreviations)
        "ғ-м", "ғыл", "т.ғ.к", "ф.ғ.к", "ф.ғ.д", "з.ғ.к", "э.ғ.к", "п.ғ.к",

        # Military / Administrative
        "ген", "полк", "подп", "подполк", "лейт", "кап", "май", "генерал-май", "и.о", "қ.м.а",
    ...
    REFERENCE_ABBRVS = Rules.REFERENCE_ABBRVS | {
        "б", "бб", "бет", "т", "тт", "том", "бап", "тарм", "ж.б", "т.с.с",
        "см", "басп",
    }

    SECTION_MARKERS = Rules.SECTION_MARKERS | {
        "Тарау", "Бөлім", "Бап", "Тармақ", "Кітап", "Кіріспе", "Қорытынды",
        "Параграф", "Том", "Сілтеме", "Қосымша", "Түсіндірме", "Ереже",
    }
