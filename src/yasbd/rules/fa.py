...
class FaRules(Rules):
    ...
    COMMON_SENT_STARTERS = {
        # Pronouns
        "من", "تو", "او", "ما", "شما", "ایشان", "این", "آن", "همین", "همان",

        # Question words
        "کی", "چه", "کجا", "چرا", "چگونه", "چطور", "کدام", "آیا",

        # Adverbs & connectors
        "اما", "ولی", "لیکن", "بااین‌حال", "زیرا", "چراکه", "چون", "بنابراین",
        "پس", "سپس", "در نتیجه", "مثلاً", "برای مثال", "ابتدا", "اول",
        "نخست", "بعد", "بعداً", "سرانجام", "نهایتاً", "در نهایت", "همچنین",
        "علاوه", "به‌عنوان", "البته", "عموماً",
    }

    REPORTING_WORDS = {
        "گفت", "گفتند", "می‌گوید", "می‌گویند", "افزود", "افزودند",
        "اضافه کرد", "اعلام کرد", "اعلام داشت", "تأکید کرد", "تأکید داشت",
        "بیان کرد", "بیان داشت", "تصریح کرد", "اشاره کرد", "نوشت",
        "می‌نویسد", "پرسید", "می‌پرسد", "پاسخ داد",
    }
